...
class gruppi_iconeViewgruppi_icone extends JView
{
	...
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('gruppi_icone') );
		$document->setMimeEncoding('application/vnd.ms-excel');		
			
		//DEVNOTE: Set ToolBar title
		JToolBarHelper::title(   JText::_( 'djfacl - Gestione gruppi utenti' ), 'generic.png' );
				
		//DEVNOTE:Get data from the model
		$items = utility::getArray("SELECT h.* from #__djfacl_gruppi_icone as h");
