...
class jtaskViewjtask extends JView
{
	/**
	 * Custom Constructor
	 */
	...
	function display($tpl = null)
	{
		...
		$document->setTitle( JText::_('Task') );
		$document->setMimeEncoding('application/vnd.ms-excel');		
			
		//DEVNOTE: Set ToolBar title
		JToolBarHelper::title(   JText::_( 'djfacl - Gestione Jtask' ), 'generic.png' );
				
		//DEVNOTE:Get data from the model
		$items = utility::getArray("SELECT h.* from #__djfacl_jtask as h");
