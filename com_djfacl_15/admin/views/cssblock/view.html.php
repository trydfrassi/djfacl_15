...
class cssblockViewcssblock extends JView
{

	function __construct( $config = array()){
	 
		global $context;
	 	$context = 'cssblock.list.';
	...
	function display($tpl = null)
	{
		...
		JToolBarHelper::title ( JText::_ ( 'Djf Acl - ').JText::_ ( 'GESTIONE_CSSBLOCK' ), 'css' );
		//	djfaclHelperToolbar::import('cssblock');
		//djfaclHelperToolbar::export('cssblock');
